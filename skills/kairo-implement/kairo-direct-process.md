...
```
@Task tool (subagent_type: general-purpose, model: {{tddTaskName}}) /mille:direct-setup {{要件名}} {{TASK-ID}}
```
...
```
@Task tool (subagent_type: general-purpose, model: {{tddTaskName}}) /mille:direct-verify {{要件名}} {{TASK-ID}}
```
